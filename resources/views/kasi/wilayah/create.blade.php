...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p>Lengkapi formulir di bawah untuk menambahkan wilayah baru (Dusun/RT/RW)</p>
        </div>

        <form action="{{ route('kasi.wilayah.store') }}" method="POST">
            @csrf
            <div class="form-body">
                <div class="info-box">
                    <i class="fas fa-info-circle"></i>
                    <div class="info-box-content">
                        <p><strong>Catatan:</strong> Koordinat (Latitude & Longitude) diperlukan untuk menampilkan wilayah di peta. Anda bisa klik pada peta di bawah untuk mendapatkan koordinat.</p>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <div class="radio-option">
                                <input type="radio" id="tipe_dusun" name="tipe" value="dusun" {{ old('tipe') === 'dusun' ? 'checked' : '' }} required onchange="toggleConditionalFields()">
                                <label for="tipe_dusun">Dusun</label>
                            </div>
                            <div class="radio-option">
                                <input type="radio" id="tipe_rt" name="tipe" value="rt" {{ old('tipe') === 'rt' ? 'checked' : '' }} onchange="toggleConditionalFields()">
                                <label for="tipe_rt">RT</label>
                            </div>
                            <div class="radio-option">
                                <input type="radio" id="tipe_rw" name="tipe" value="rw" {{ old('tipe') === 'rw' ? 'checked' : '' }} onchange="toggleConditionalFields()">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <small class="form-text">Klik pada peta di bawah untuk mendapatkan koordinat</small>
                        @error('latitude')
                            <span class="error-message">
                                <i class="fas fa-exclamation-circle"></i>
                                {{ $message }}
                ...
                <div class="form-group">
                    ...
                    <small class="form-text">Klik pada peta untuk menandai lokasi wilayah</small>
                </div>
...
<script>
    ...
    map.on('click', function(e) {
        ...
        marker.bindPopup(`<b>Lokasi Terpilih</b><br>Lat: ${lat}<br>Lng: ${lng}`).openPopup();
    });

    // Call on page load to show correct fields if there's old input
